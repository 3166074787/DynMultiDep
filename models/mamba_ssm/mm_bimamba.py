...
import sys
# sys.path.append('/home/yjy/PycharmProjects/PythonProject/DepMamba2')
import math
...
# try:
#     from mamba_ssm.selective_scan_interface import selective_scan_fn, mamba_inner_fn, bimamba_inner_fn, mamba_inner_fn_no_out_proj
# except ImportError:
